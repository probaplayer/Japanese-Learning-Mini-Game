...
This project is indexed by GitNexus as **Japanese-Learning-Mini-Game** (3180 symbols, 5043 relationships, 269 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
